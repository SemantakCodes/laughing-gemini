  ...
  static ThemeData get themeData {
    return ThemeData(
      ...
      textTheme: GoogleFonts.nunitoTextTheme().copyWith(
        displayLarge: GoogleFonts.caveat(color: textPrimary),
        displayMedium: GoogleFonts.caveat(color: textPrimary),
        displaySmall: GoogleFonts.caveat(color: textPrimary),
        headlineMedium: GoogleFonts.caveat(color: textPrimary, fontWeight: FontWeight.bold),
        titleLarge: GoogleFonts.caveat(color: textPrimary, fontWeight: FontWeight.bold),
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: inputBg,
        hintStyle: GoogleFonts.nunito(color: textMuted, fontSize: 13),
